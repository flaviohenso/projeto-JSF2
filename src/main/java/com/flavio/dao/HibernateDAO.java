...
import com.flavio.conectionDB.HibernateUtil;
...
//
	public void save(T entity) {
		...
		((EntityManager) HibernateUtil.getRequestAtribute("entityManager")).persist(entity);
...
//	}
	...
	public List<T> listAll() {// por ordem de inserção
		...
		CriteriaBuilder criteriaBuilder = ((EntityManager) HibernateUtil.getRequestAtribute("entityManager")).getCriteriaBuilder();
		...
		this.criteriaQuery.select(this.root); // necessário caso uma condição
												...
												// consulta
		this.query = HibernateUtil.getConnection().createQuery(this.criteriaQuery);
	...
	public List<T> listAllasc(String coluna) {// por ordem acendente
		...
		this.criteriaQuery.select(this.root); // necessário caso uma condição
												// where seja adicionada na
												// consulta
		this.query = HibernateUtil.getConnection()
